...
Interactive map companion to the paper _A multi-pathway contamination risk model for Niger Delta communities: integrating hydrocarbon load, heavy metal exposure, and vegetation stress indices from heterogeneous observational data_. Built with Mapbox GL JS and Vite.
